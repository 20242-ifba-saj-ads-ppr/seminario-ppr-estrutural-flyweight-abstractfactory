...
class FlyWeightApp {
    companion object {
        ...
        @JvmStatic
        fun run() {
            println("Teste com $INTERACOES elementos no mapa (Com Flyweight)")
            ...
            for (i in 0 until INTERACOES) {
                ...
                val element = MapElementFactory.createMapElement(
                    pos,
                    "Elemento$i",
            ...
            imprimirMemoria("Depois de criar elementos (Com Flyweight)")
